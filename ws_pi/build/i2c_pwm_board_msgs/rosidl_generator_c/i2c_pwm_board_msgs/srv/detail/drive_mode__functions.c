...
i2c_pwm_board_msgs__srv__DriveMode_Request__init(i2c_pwm_board_msgs__srv__DriveMode_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->mode)) {
    i2c_pwm_board_msgs__srv__DriveMode_Request__fini(msg);
    return false;
  }
  // rpm
  // radius
  ...
  // scale
  // servos
  if (!i2c_pwm_board_msgs__msg__Position__Sequence__init(&msg->servos, 0)) {
    i2c_pwm_board_msgs__srv__DriveMode_Request__fini(msg);
    return false;
  }
  return true;
...
i2c_pwm_board_msgs__srv__DriveMode_Request__fini(i2c_pwm_board_msgs__srv__DriveMode_Request * msg)
{
  ...
  // scale
  // servos
  i2c_pwm_board_msgs__msg__Position__Sequence__fini(&msg->servos);
}
...
i2c_pwm_board_msgs__srv__DriveMode_Request__are_equal(const i2c_pwm_board_msgs__srv__DriveMode_Request * lhs, const i2c_pwm_board_msgs__srv__DriveMode_Request * rhs)
{
  ...
  // servos
  if (!i2c_pwm_board_msgs__msg__Position__Sequence__are_equal(
  ...
  i2c_pwm_board_msgs__srv__DriveMode_Request * output)
{
  ...
  // servos
  if (!i2c_pwm_board_msgs__msg__Position__Sequence__copy(
...
i2c_pwm_board_msgs__srv__DriveMode_Request__create()
{
  ...
  i2c_pwm_board_msgs__srv__DriveMode_Request * msg = (i2c_pwm_board_msgs__srv__DriveMode_Request *)allocator.allocate(sizeof(i2c_pwm_board_msgs__srv__DriveMode_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(i2c_pwm_board_msgs__srv__DriveMode_Request));
  bool success = i2c_pwm_board_msgs__srv__DriveMode_Request__init(msg);
  if (!success) {
...
i2c_pwm_board_msgs__srv__DriveMode_Request__Sequence__init(i2c_pwm_board_msgs__srv__DriveMode_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  i2c_pwm_board_msgs__srv__DriveMode_Request * data = NULL;

  if (size) {
    data = (i2c_pwm_board_msgs__srv__DriveMode_Request *)allocator.zero_allocate(size, sizeof(i2c_pwm_board_msgs__srv__DriveMode_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = i2c_pwm_board_msgs__srv__DriveMode_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        i2c_pwm_board_msgs__srv__DriveMode_Request__fini(&data[i - 1]);
      }
...
i2c_pwm_board_msgs__srv__DriveMode_Request__Sequence__fini(i2c_pwm_board_msgs__srv__DriveMode_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      i2c_pwm_board_msgs__srv__DriveMode_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  i2c_pwm_board_msgs__srv__DriveMode_Request__Sequence * array = (i2c_pwm_board_msgs__srv__DriveMode_Request__Sequence *)allocator.allocate(sizeof(i2c_pwm_board_msgs__srv__DriveMode_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = i2c_pwm_board_msgs__srv__DriveMode_Request__Sequence__init(array, size);
  if (!success) {
...
i2c_pwm_board_msgs__srv__DriveMode_Request__Sequence__destroy(i2c_pwm_board_msgs__srv__DriveMode_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    i2c_pwm_board_msgs__srv__DriveMode_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
i2c_pwm_board_msgs__srv__DriveMode_Request__Sequence__are_equal(const i2c_pwm_board_msgs__srv__DriveMode_Request__Sequence * lhs, const i2c_pwm_board_msgs__srv__DriveMode_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!i2c_pwm_board_msgs__srv__DriveMode_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  i2c_pwm_board_msgs__srv__DriveMode_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(i2c_pwm_board_msgs__srv__DriveMode_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    i2c_pwm_board_msgs__srv__DriveMode_Request * data =
      (i2c_pwm_board_msgs__srv__DriveMode_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!i2c_pwm_board_msgs__srv__DriveMode_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          i2c_pwm_board_msgs__srv__DriveMode_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!i2c_pwm_board_msgs__srv__DriveMode_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  i2c_pwm_board_msgs__srv__DriveMode_Response * msg = (i2c_pwm_board_msgs__srv__DriveMode_Response *)allocator.allocate(sizeof(i2c_pwm_board_msgs__srv__DriveMode_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(i2c_pwm_board_msgs__srv__DriveMode_Response));
  bool success = i2c_pwm_board_msgs__srv__DriveMode_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
i2c_pwm_board_msgs__srv__DriveMode_Response__destroy(i2c_pwm_board_msgs__srv__DriveMode_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    i2c_pwm_board_msgs__srv__DriveMode_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
i2c_pwm_board_msgs__srv__DriveMode_Response__Sequence__init(i2c_pwm_board_msgs__srv__DriveMode_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  i2c_pwm_board_msgs__srv__DriveMode_Response * data = NULL;

  if (size) {
    data = (i2c_pwm_board_msgs__srv__DriveMode_Response *)allocator.zero_allocate(size, sizeof(i2c_pwm_board_msgs__srv__DriveMode_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = i2c_pwm_board_msgs__srv__DriveMode_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        i2c_pwm_board_msgs__srv__DriveMode_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
i2c_pwm_board_msgs__srv__DriveMode_Response__Sequence__fini(i2c_pwm_board_msgs__srv__DriveMode_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      i2c_pwm_board_msgs__srv__DriveMode_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  i2c_pwm_board_msgs__srv__DriveMode_Response__Sequence * array = (i2c_pwm_board_msgs__srv__DriveMode_Response__Sequence *)allocator.allocate(sizeof(i2c_pwm_board_msgs__srv__DriveMode_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = i2c_pwm_board_msgs__srv__DriveMode_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
i2c_pwm_board_msgs__srv__DriveMode_Response__Sequence__destroy(i2c_pwm_board_msgs__srv__DriveMode_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    i2c_pwm_board_msgs__srv__DriveMode_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
i2c_pwm_board_msgs__srv__DriveMode_Response__Sequence__are_equal(const i2c_pwm_board_msgs__srv__DriveMode_Response__Sequence * lhs, const i2c_pwm_board_msgs__srv__DriveMode_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!i2c_pwm_board_msgs__srv__DriveMode_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  i2c_pwm_board_msgs__srv__DriveMode_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(i2c_pwm_board_msgs__srv__DriveMode_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    i2c_pwm_board_msgs__srv__DriveMode_Response * data =
      (i2c_pwm_board_msgs__srv__DriveMode_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!i2c_pwm_board_msgs__srv__DriveMode_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          i2c_pwm_board_msgs__srv__DriveMode_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!i2c_pwm_board_msgs__srv__DriveMode_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
