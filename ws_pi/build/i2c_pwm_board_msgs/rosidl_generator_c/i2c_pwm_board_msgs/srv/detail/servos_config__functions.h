...
#ifndef I2C_PWM_BOARD_MSGS__SRV__DETAIL__SERVOS_CONFIG__FUNCTIONS_H_
#define I2C_PWM_BOARD_MSGS__SRV__DETAIL__SERVOS_CONFIG__FUNCTIONS_H_
...
/// Initialize srv/ServosConfig message.
/**
...
/// Finalize srv/ServosConfig message.
/**
...
/// Create srv/ServosConfig message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * i2c_pwm_board_msgs__srv__ServosConfig_Request__init().
...
/// Destroy srv/ServosConfig message.
/**
 * It calls
 * i2c_pwm_board_msgs__srv__ServosConfig_Request__fini()
...
/// Check for srv/ServosConfig message equality.
/**
...
/// Copy a srv/ServosConfig message.
/**
...
/// Initialize array of srv/ServosConfig messages.
/**
...
/// Finalize array of srv/ServosConfig messages.
/**
 * It calls
 * i2c_pwm_board_msgs__srv__ServosConfig_Request__fini()
...
/// Create array of srv/ServosConfig messages.
/**
 * It allocates the memory for the array and calls
 * i2c_pwm_board_msgs__srv__ServosConfig_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ServosConfig messages.
/**
 * It calls
 * i2c_pwm_board_msgs__srv__ServosConfig_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ServosConfig message array equality.
/**
...
/// Copy an array of srv/ServosConfig messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * i2c_pwm_board_msgs__srv__ServosConfig_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_i2c_pwm_board_msgs
...
/**
 * It calls
 * i2c_pwm_board_msgs__srv__ServosConfig_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_i2c_pwm_board_msgs
...
/**
 * It allocates the memory for the array and calls
 * i2c_pwm_board_msgs__srv__ServosConfig_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_i2c_pwm_board_msgs
...
/**
 * It calls
 * i2c_pwm_board_msgs__srv__ServosConfig_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // I2C_PWM_BOARD_MSGS__SRV__DETAIL__SERVOS_CONFIG__FUNCTIONS_H_
