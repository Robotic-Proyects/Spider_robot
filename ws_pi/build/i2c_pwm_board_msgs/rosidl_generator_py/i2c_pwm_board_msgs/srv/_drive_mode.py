...
class Metaclass_DriveMode(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'i2c_pwm_board_msgs.srv.DriveMode')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from i2c_pwm_board_msgs.srv import _drive_mode
...
class DriveMode(metaclass=Metaclass_DriveMode):
    from i2c_pwm_board_msgs.srv._drive_mode import DriveMode_Request as Request
    from i2c_pwm_board_msgs.srv._drive_mode import DriveMode_Response as Response
