...
class Metaclass_IntValue(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'i2c_pwm_board_msgs.srv.IntValue')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from i2c_pwm_board_msgs.srv import _int_value
...
class IntValue(metaclass=Metaclass_IntValue):
    from i2c_pwm_board_msgs.srv._int_value import IntValue_Request as Request
    from i2c_pwm_board_msgs.srv._int_value import IntValue_Response as Response
