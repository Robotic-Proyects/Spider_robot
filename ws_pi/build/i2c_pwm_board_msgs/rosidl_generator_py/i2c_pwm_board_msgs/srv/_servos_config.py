...
class Metaclass_ServosConfig(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'i2c_pwm_board_msgs.srv.ServosConfig')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from i2c_pwm_board_msgs.srv import _servos_config
...
class ServosConfig(metaclass=Metaclass_ServosConfig):
    from i2c_pwm_board_msgs.srv._servos_config import ServosConfig_Request as Request
    from i2c_pwm_board_msgs.srv._servos_config import ServosConfig_Response as Response
