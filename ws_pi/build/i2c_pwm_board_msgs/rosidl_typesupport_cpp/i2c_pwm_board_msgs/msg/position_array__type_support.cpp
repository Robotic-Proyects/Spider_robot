...
static const _PositionArray_type_support_symbol_names_t _PositionArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, i2c_pwm_board_msgs, msg, PositionArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, i2c_pwm_board_msgs, msg, PositionArray)),
  }
};
...
{
  return &::i2c_pwm_board_msgs::msg::rosidl_typesupport_cpp::PositionArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, i2c_pwm_board_msgs, msg, PositionArray)() {
  return get_message_type_support_handle<i2c_pwm_board_msgs::msg::PositionArray>();
}
