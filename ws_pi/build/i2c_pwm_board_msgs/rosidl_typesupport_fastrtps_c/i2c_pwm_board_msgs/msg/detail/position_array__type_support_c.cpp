...
#include "i2c_pwm_board_msgs/msg/detail/position_array__rosidl_typesupport_fastrtps_c.h"
...
using _PositionArray__ros_msg_type = i2c_pwm_board_msgs__msg__PositionArray;
...
size_t get_serialized_size_i2c_pwm_board_msgs__msg__PositionArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PositionArray__ros_msg_type * ros_message = static_cast<const _PositionArray__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _PositionArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_i2c_pwm_board_msgs__msg__PositionArray(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_i2c_pwm_board_msgs
size_t max_serialized_size_i2c_pwm_board_msgs__msg__PositionArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = i2c_pwm_board_msgs__msg__PositionArray;
    is_plain =
      (
...
static size_t _PositionArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_i2c_pwm_board_msgs__msg__PositionArray(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, i2c_pwm_board_msgs, msg, PositionArray)() {
