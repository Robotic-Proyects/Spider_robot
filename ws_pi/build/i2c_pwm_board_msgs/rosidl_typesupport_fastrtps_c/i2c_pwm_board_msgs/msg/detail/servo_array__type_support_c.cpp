  ...
  // Field name: servos
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, i2c_pwm_board_msgs, msg, Servo
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _ServoArray__ros_msg_type * ros_message = static_cast<_ServoArray__ros_msg_type *>(untyped_ros_message);
  // Field name: servos
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
