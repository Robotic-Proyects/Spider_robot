...
#include "i2c_pwm_board_msgs/msg/detail/servo_config_array__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = i2c_pwm_board_msgs::msg::ServoConfigArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const i2c_pwm_board_msgs::msg::ServoConfigArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<i2c_pwm_board_msgs::msg::ServoConfigArray *>(
    untyped_ros_message);
...
{
  return &i2c_pwm_board_msgs::msg::typesupport_fastrtps_cpp::_ServoConfigArray__handle;
}
