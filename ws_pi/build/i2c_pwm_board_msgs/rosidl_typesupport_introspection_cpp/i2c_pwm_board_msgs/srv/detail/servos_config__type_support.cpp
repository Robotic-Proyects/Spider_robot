...
{
  new (message_memory) i2c_pwm_board_msgs::srv::ServosConfig_Request(_init);
}

void ServosConfig_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<i2c_pwm_board_msgs::srv::ServosConfig_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ServosConfig_Request_message_member_array[1] = {
  {
    ...
    offsetof(i2c_pwm_board_msgs::srv::ServosConfig_Request, servos),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ServosConfig_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(i2c_pwm_board_msgs::srv::ServosConfig_Request),
...
{
  return &::i2c_pwm_board_msgs::srv::rosidl_typesupport_introspection_cpp::ServosConfig_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, i2c_pwm_board_msgs, srv, ServosConfig_Request)() {
  return &::i2c_pwm_board_msgs::srv::rosidl_typesupport_introspection_cpp::ServosConfig_Request_message_type_support_handle;
}
...
void ServosConfig_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) i2c_pwm_board_msgs::srv::ServosConfig_Response(_init);
}

void ServosConfig_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<i2c_pwm_board_msgs::srv::ServosConfig_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ServosConfig_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(i2c_pwm_board_msgs::srv::ServosConfig_Response, error),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ServosConfig_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(i2c_pwm_board_msgs::srv::ServosConfig_Response),
...
{
  return &::i2c_pwm_board_msgs::srv::rosidl_typesupport_introspection_cpp::ServosConfig_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, i2c_pwm_board_msgs, srv, ServosConfig_Response)() {
  return &::i2c_pwm_board_msgs::srv::rosidl_typesupport_introspection_cpp::ServosConfig_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers ServosConfig_service_members = {
  ...
  // see get_service_type_support_handle<i2c_pwm_board_msgs::srv::ServosConfig>()
...
get_service_type_support_handle<i2c_pwm_board_msgs::srv::ServosConfig>()
{
  ...
  auto service_type_support =
    &::i2c_pwm_board_msgs::srv::rosidl_typesupport_introspection_cpp::ServosConfig_service_type_support_handle;
    ...
    service_members->response_members_ == nullptr)
  {
    ...
    service_members->request_members_ = static_cast<
      ...
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::i2c_pwm_board_msgs::srv::ServosConfig_Request
      >()->data
      );
    ...
    service_members->response_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::i2c_pwm_board_msgs::srv::ServosConfig_Response
      >()->data
      );
  }
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, i2c_pwm_board_msgs, srv, ServosConfig)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<i2c_pwm_board_msgs::srv::ServosConfig>();
}
