...
static const _SpiderSwitch_type_support_symbol_names_t _SpiderSwitch_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, spider_msgs, msg, SpiderSwitch)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, spider_msgs, msg, SpiderSwitch)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, spider_msgs, msg, SpiderSwitch)() {
  return &::spider_msgs::msg::rosidl_typesupport_c::SpiderSwitch_message_type_support_handle;
}
